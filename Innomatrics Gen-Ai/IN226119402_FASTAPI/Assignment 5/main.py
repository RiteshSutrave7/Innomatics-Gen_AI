...
def sort_products_by_category():
    ...
    return {
        'message': 'Products grouped by category and sorted by price',
...
def browse_products(
    ...
    sorted_list=sorted(filtered, key=lambda p: p.get(sort_by, "price"), reverse=is_reverse)
    ...
    paged_results=sorted_list[start:end]
    return {
        "search_metadata": {
